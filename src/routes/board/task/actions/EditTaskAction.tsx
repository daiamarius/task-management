...
export const EditTaskAction: React.FC<Props> = ({task}) => {
  ...
  const FormSchema = z.object({
    ...
    status: z
      .union(
        [z.literal('DONE'), z.literal('TESTING'), z.literal('TODO'), z.literal('IN PROGRESS')],
        {
            ...
            <FormField
              ...
              render={({field}) => (
                <FormItem>
                  <FormLabel>Title</FormLabel>
                  <FormControl>
                    <Textarea placeholder="This is how the feature is going to be implemented ..." {...field} />
                  </FormControl>
                  <FormMessage/>
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({field}) => (
                <FormItem>
                  ...
                  <UserSelect onValueChange={field.onChange} defaultValue={field.value}/>
                  <FormMessage/>
                </FormItem>
              )}
            />
